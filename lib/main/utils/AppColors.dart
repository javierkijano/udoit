...
const app_primaryColor = Color(0xFF2B5266);
const app_gradientColor1 = Color(0xFFF2F5F9);
const app_gradientColor2 = Color(0xFFB4C5D1);

const app_backgroundColor = Color(0xFFFAFAFA);
const app_whiteColor = Color(0xFFffffff);
const app_blackColor = Color(0xFF000000);
const app_greyColor = Color(0xFF808080);
const app_bottomNavColor = Color(0xFF808080);

const t12_text_color_primary = Color(0xFFFAFAFA);
